 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Digitalus_Service_PayPal_Response
{
...
//			throw new Digitalus_PayPal_PayPal_Exception('Provided data does not seem to be a valid PayPal NVP API response');
			throw new Digitalus_Service_PayPal_Exception('Provided data does not seem to be a valid PayPal NVP API response');
		}
