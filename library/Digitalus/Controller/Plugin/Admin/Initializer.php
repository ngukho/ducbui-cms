 ...
 * @since      Release 1.8.0
 */
class Digitalus_Controller_Plugin_Admin_Initializer extends Zend_Controller_Plugin_Abstract
{
    /**
...
////                $this->view->setScriptPath($config->filepath->adminViews);
        ...
        $this->view->jQuery()->setLocalPath(BASE_URL . '/scripts/jquery-1.3.2.min.js');
        $this->view->jQuery()->setUiLocalPath(BASE_URL . '/scripts/jquery-ui-1.7.custom.min.js');
        $this->view->jQuery()->addStylesheet(BASE_URL . '/scripts/ui-theme/jquery-ui-1.7.1.custom.css');
