<?php
class Model_Menus extends Digitalus_Db_Table
{
    protected $_name = 'core_menus';
   	protected $_primaryKey = 'menu_id'; 
   	private $_cache_key = 'admin_main_menu';
    ...
    protected $_referenceMap    = array(                
        ...
        'Model_AdminPanels' => array(                               
            'columns'           => array('admin_panel_id'),   
            'refTableClass'     => 'Model_AdminPanels',            
            'refColumns'        => array('admin_panel_id'),    
            'onDelete'          => self::CASCADE,
            'onUpdate'          => self::RESTRICT
        )             
    ); 
...
//	public function getAllChildrenID($parentID,$getThis = true,$returnArray = false)
//    {
//    	$str = '';
//    	$this->processGetAllChildrenID($parentID,&$str);
//    	$str = substr($str, 0, strlen($str) - 1);
//    	if($getThis) 
//    		$str = ($str == '' ? $parentID : $parentID . ',' . $str);
//    	if($returnArray)
//    		return explode(",", $str);
//    	return $str;
//    }
//    
//    private function processGetAllChildrenID($parentID,&$strID)
//    {  
//  
//  		$thisObj = new self;
//    	$where = 'parent = ' . $parentID;
//     	$rsObj = $thisObj->fetchAll($where);     
//     
//     	foreach($rsObj as $Obj ) :
//      		$strID .= $Obj->sbCategoryID . ",";
//      		$this->processGetAllChildrenID($Obj->sbCategoryID,$strID);   
//     	endforeach;
//  	}    
